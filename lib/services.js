...
const PASSES = [
  {
    id: 'dropin', name: 'Drop-In', cents: 5000, unit: 'Per Day', days: 1,
    desc: 'Perfect for busy schedules, extra reps, or experiencing the Velo difference.',
  },
  {
    id: 'flex3', name: '3-Day Flex Pass', cents: 10000, unit: 'Per Week', days: 3, popular: true,
    desc: 'Perfect for multi-sport athletes and busy families — train any 3 days, Monday–Friday.',
  },
  {
    id: 'unlimited', name: 'Unlimited Week', cents: 15000, unit: 'Per Week', days: 5,

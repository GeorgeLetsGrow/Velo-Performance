        ...
        itemListElement: [
          {
            ...
            itemOffered: {
              '@type': 'Service',
              name: 'After-School Training',
              description: 'Player development until 5 PM, priced at $25 Monday and $20 Tuesday through Friday.',
            },
          },
          {
            '@type': 'Offer',
            itemOffered: {
              '@type': 'Service',
              name: 'Evening Skills Training',
              description: 'Baseball and softball skills practice Monday, Wednesday, and Thursday from 5:30 to 7 PM.',
            },
          },
          {
            '@type': 'Offer',
            itemOffered: {
              ...
              description: 'Sunday one-on-one baseball or softball training with a coach from noon to 7 PM.',
            },
          },
        ],
      },
    },
    {
      ...
      mainEntity: [
        ...
        },
        {
          ...
          acceptedAnswer: {
            '@type': 'Answer',
            text: 'After-school training runs Monday through Friday. Evening Skills Training runs Monday, Wednesday, and Thursday from 5:30 to 7 PM, and private lessons are available Sundays from noon to 7 PM.',
          },
        },
      ],
    },

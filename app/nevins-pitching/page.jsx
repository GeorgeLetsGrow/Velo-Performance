...
export default function NevinsPitching(){
  ...
  return <main className={s.page}>
    ...
    <section className={s.hero}><div><p className={s.kicker}>Thursdays · 6:00–7:00 PM</p><h1>Nevin's <em>Pitching</em></h1><p className={s.lead}>Pitch with purpose.</p><div className={s.facts}><strong>$20<small>per player</small></strong><span>Former White Sox pitcher</span><span>Limited spots</span></div><a className={s.cta} href="#reserve">Reserve a spot ↓</a></div><div className={s.image}><img src="/assets/pitching-clinic.jpg" alt="Nevin Griffith pitching clinic flyer"/></div></section>
